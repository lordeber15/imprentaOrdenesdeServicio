import logo from "../assets/logodialCircular.svg"
...
function Login() {
  ...
  return (
    <div className="flex place-content-center h-screen">
        ...
        <button className=" w-full bg-cyan-500 rounded-md py-2 my-2 font-bold text-blue-50 text-lg" onClick={()=>{navigate("/dashboard")}}>Ingresar</button>
        </div>
