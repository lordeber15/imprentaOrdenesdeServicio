    ...
    return (
      <div className="flex flex-col">
          ...
          <div className=" text-lg font-bold flex justify-center content-center bg-cyan-600 text-white px-3 py-2 rounded-md " onClick={()=>{navigate("/dashboard")}}>
            ...
            <h1 className="py-1 text-4xl font-bold text-black">Ordenes de Servicio</h1>
            <div></div>
          </div>
          ...
          <Modal open={open} onClose={()=>{setOpen(false)}}>
            <div className="">
              ...
              <input type="number" min={0} className=" px-3 py-2 text-cyan-600 font-semibold rounded-md border-2 border-solid focus:border-cyan-500  focus:outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"/>
              </div>
              <div className="flex flex-col w-1/2">
              ...
              <input type="number" className=" px-3 py-2 text-cyan-600 font-semibold rounded-md border-2 border-solid focus:border-cyan-500  focus:outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"/>
              </div>
              <div className="flex flex-col w-1/2">
              ...
              <div className="flex justify-end py-2">
                <button className="bg-cyan-600 px-4 py-2 font-semibold rounded-md text-white hover:bg-cyan-700 hover:scale-105">Guardar</button>
              </div>
